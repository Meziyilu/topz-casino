// app/api/casino/roulette/overview/route.ts
import { NextResponse } from "next/server";
import { z } from "zod";
import { getOverview, ensureRoomLoop } from "@/services/roulette.service";
...
export async function GET(req: Request) {
  ...
  const data = await getOverview(parsed.data.room);
