...
export default function SicboBoard({
  ...
  const bigSmall = [
    { key: "BIG", title: "大", odds: odds.bigSmall.BIG, payload: { kind: "BIG_SMALL", bigSmall: "BIG" } },
    { key: "SMALL", title: "小", odds: odds.bigSmall.SMALL, payload: { kind: "BIG_SMALL", bigSmall: "SMALL" } },
  ];
